<template>
  <div class="modal-background fade-id" @click.self="$emit('on:close')">
    <div class="modal-container">
      <slot name="header"></slot>
      <slot name="body">:v</slot>
      ...
      <!-- <slot /> -->
      <!-- <slot>
        <div class="center">Esto aparacera si no tenemos contenido</div>
      </slot> -->
    </div>
  </div>
</template>
...
export default {
  ...
  setup(props, context) {
    ...
    return {
      newTitle: props.test1?.toUpperCase(),
    };
  },
};
</script>
